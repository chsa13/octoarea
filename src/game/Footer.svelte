...
<footer class:mobile={$isMobile}>
  ...
  <div class="author-content">
    ...
    <ul class="social-links"><span>{$lang('Contacts')}:</span>
      <li>
        <a href={config.author.github} target="_blank" rel="noopener noreferrer">GitHub</a>
      </li>,
      <li>
        <a href={config.author.telegram} target="_blank" rel="noopener noreferrer">Telegram</a>
      </li>
    </ul>
  </div>
</footer>